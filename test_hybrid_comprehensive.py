...
async def test_hybrid_ai_comprehensive():
    ...
    try:
        ...
        expected_providers = [
            'llama_self_hosted', 'mistral_self_hosted', 
            'deepseek_api', 'claude_api', 'openai_api'
        ]
    ...
    try:
        ...
        for task_type, description in task_tests:
            ...
            assert models[-1].value == 'openai_api', f"OpenAI not fallback for {task_type}"
    ...
    try:
        ...
        for prompt, task_type in test_prompts:
            ...
            total_cost = sum(data.get("estimated_cost_usd", 0) for data in analysis.values())
    ...
    try:
        ...
        for prompt, task_type in test_cases:
            ...
            if "error" not in comparison:
                ...
                print(f"   ✅ {task_type.value}: {savings:.1f}% savings, {recommended} recommended")
            else:
    ...
    try:
        ...
        print(f"   ✅ {available_count}/{len(availability_results)} providers available")
