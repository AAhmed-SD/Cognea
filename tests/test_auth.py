...
class TestGetCurrentUser:
    ...
    @patch('services.auth.security_config')
    def test_get_current_user_valid_token(self, mock_security_config, mock_get_supabase):
        ...
        token = jwt.encode(token_data, mock_security_config.SECRET_KEY, algorithm=mock_security_config.JWT_ALGORITHM)
    ...
    @patch('services.auth.get_supabase_client')
    @patch('services.auth.security_config')
    def test_get_current_user_user_not_found(self, mock_security_config, mock_get_supabase):
