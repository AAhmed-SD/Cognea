...
class TestSimpleScheduler:
    ...
    def test_schedule_tasks(self):
        ...
        assert schedule[0]["task"].priority == "high"  # High priority should be scheduled first
    ...
    def test_schedule_tasks_insufficient_slots(self):
        ...
        assert schedule[0]["task"].priority == "high"  # Highest priority should be scheduled
        ...
        current_schedule = [
            {
                ...
                "end_time": time_slot.start_time + timedelta(minutes=task.estimated_minutes),
            }
        ]
        
        optimized_schedule = scheduler.optimize_schedule(current_schedule, user_energy=7)
        ...
        schedule = [
            {
                ...
                "end_time": time_slot1.start_time + timedelta(minutes=task1.estimated_minutes),
            },
            {
                "task": task2,
                ...
                "end_time": time_slot2.start_time + timedelta(minutes=task2.estimated_minutes),
            }
        ]
        ...
        schedule = [
            {
                ...
                "score": 0.8,
                "start_time": time_slot.start_time,
                "end_time": time_slot.start_time + timedelta(minutes=task1.estimated_minutes),
            },
            {
                "task": task2,
                "time_slot": time_slot,
                "score": 0.6,
                "start_time": time_slot.start_time,
                "end_time": time_slot.start_time + timedelta(minutes=task2.estimated_minutes),
            }
        ]
    ...
    def test_calculate_schedule_efficiency_with_breaks(self):
        ...
        schedule = [
            ...
            },
            {
                ...
                "score": 0.1,
                "start_time": time_slot.start_time,
                "end_time": time_slot.start_time + timedelta(minutes=break_task.estimated_minutes),
            }
        ]
