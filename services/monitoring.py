...
TOKEN_USAGE = Counter('openai_tokens_total', 'Total OpenAI tokens used', ['model', 'user_id'])
...
class MonitoringService:
    ...
    def log_error(self, endpoint: str, error_type: str, error_message: str, user_id: Optional[str] = None):
        """Log API errors."""
    ...
    def track_token_usage(self, user_id: str, model: str, tokens_used: int, cost_usd: float):
