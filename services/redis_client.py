...
class RedisClient:
    ...
    def get_rate_limit_info(self, key: str) -> Dict[str, Any]:
        ...
        reset_time = None
        if oldest:
            reset_time = datetime.fromtimestamp(oldest[0][1] + window_seconds).isoformat()
    ...
    def track_token_usage(self, user_id: str, tokens_used: int, cost_usd: float, model: str):
    ...
    def check_budget_limit(self, user_id: str, cost_usd: float, daily_limit: float = 10.0, monthly_limit: float = 100.0) -> bool:
